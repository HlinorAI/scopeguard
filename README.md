...
1. **The user-facing product** — a hosted browser app for finance, sales, account and delivery teams. These users should open a link and work with projects without installing software or using a terminal.
...
2. Open the public pilot; no GitHub, Node.js or npm account is required.
